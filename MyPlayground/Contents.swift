...
var sportCar = SportCar(vehicleType: .Спортивный, model: "Mercedes-Benz-E63", manYear: 2019, cargoCapacity: 1600, color: .Красный, mp3: .Присутствует, transmission: .Автоматическая, engineType: .Бензин, suspension: .Воздух, body: .Седан, axles: .Две, engine: EngineStatus.Запущен, window: WindowStatus.Открыты, cargo: CargoStatus.Полный, airCon: .Присутствует)
...
var motorcycle = Motocycle(vehicleType: .Мотоцикл, model: "Honda-Ninha-ZX-10R", manYear: 2010, cargoCapacity: 90, color: .Зеленый, mp3: .Отсутствует, transmission: .Ручная, engineType: .Бензин, suspension: .Пружины, body: .Отсутствует, axles: .Две, engine: EngineStatus.Запущен)
